...
typedef CGAL::CK2_Intersection_traits<Circular_k, Circular_arc_2, Circular_arc_2>::type Intersection_result_2;
typedef CGAL::CK2_Intersection_traits<Circular_k, Line_arc_2, Circular_arc_2>::type Intersection_result;
...
int main() {
    ...
    intersection(l3,ar2,back_inserter(res));
